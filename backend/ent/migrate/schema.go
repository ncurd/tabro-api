...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "oidc_tenant", Type: field.TypeString, Nullable: true},
		{Name: "tabro_run_id", Type: field.TypeString, Nullable: true},
		{Name: "tabro_project_id", Type: field.TypeString, Nullable: true},
