...
func init() {
	...
	// apikeyDescOidcManaged is the schema descriptor for oidc_managed field.
	apikeyDescOidcManaged := apikeyFields[5].Descriptor()
	// apikey.DefaultOidcManaged holds the default value on creation for the oidc_managed field.
	apikey.DefaultOidcManaged = apikeyDescOidcManaged.Default.(bool)
	// apikeyDescOidcIssuer is the schema descriptor for oidc_issuer field.
	apikeyDescOidcIssuer := apikeyFields[6].Descriptor()
	// apikey.OidcIssuerValidator is a validator for the "oidc_issuer" field. It is called by the builders before save.
	apikey.OidcIssuerValidator = apikeyDescOidcIssuer.Validators[0].(func(string) error)
	// apikeyDescOidcSubject is the schema descriptor for oidc_subject field.
	apikeyDescOidcSubject := apikeyFields[7].Descriptor()
	// apikey.OidcSubjectValidator is a validator for the "oidc_subject" field. It is called by the builders before save.
	apikey.OidcSubjectValidator = apikeyDescOidcSubject.Validators[0].(func(string) error)
