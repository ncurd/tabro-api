		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName:     "Tabro",
					service.SettingKeySMTPUseTLS:       "true",
					service.SettingKeySMTPSecurity:     "tls",
					service.SettingKeySMTPAuthProtocol: "plain",
					...
					service.SettingKeySiteName:     "Tabro",
...
func newContractDeps(t *testing.T) *contractDeps {
	...
	authHandler := handler.NewAuthHandler(cfg, nil, apiKeyService, userService, settingService, nil, redeemService, nil)
