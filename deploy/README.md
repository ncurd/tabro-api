# Tabro Deployment Files

This directory contains files for deploying Tabro on Linux servers.
...
curl -sSL https://raw.githubusercontent.com/ncurd/tabro-api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
Tabro supports three methods to connect to Gemini:
...
1. Download the latest release from [GitHub Releases](https://github.com/ncurd/tabro-api/releases)
...
Tabro supports TLS fingerprint simulation to make requests appear as if they come from the official Claude CLI (Node.js client).
