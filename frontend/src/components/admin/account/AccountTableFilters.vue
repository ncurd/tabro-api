...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: 'Anthropic' }, { value: 'openai', label: 'OpenAI' }, { value: 'gemini', label: 'Gemini' }, { value: 'antigravity', label: 'Antigravity' }, { value: 'dashscope', label: 'DashScope / Wan' }, { value: 'volcengine_ark', label: 'Volcengine Ark / Seedance' }, { value: 'azure_speech', label: 'Azure Speech' }])
