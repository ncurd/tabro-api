// Simplified Chinese locale (full standalone copy)
export default {
  "home": {
  ...
  "profile": {
    ...
    "balanceNotify": {
      ...
      "systemDefault": "系统默认",
      "extraEmails": "通知邮箱",
      "extraEmailsHint": "必须先添加并验证邮箱地址，才能接收余额不足提醒",
      "primaryEmail": "主邮箱",
  ...
  "admin": {
    ...
    "groups": {
      ...
      "claudeMaxSimulation": {
        ...
        "tooltip": "启用后，对于没有上游 cache-write 用量的 Claude 模型，系统会在保持总 Token 不变的前提下，确定性地将其映射为少量输入 Token 加 1 小时缓存创建用量。",
    ...
    "channels": {
      ...
      "form": {
        ...
        "webSearchEmulationHint": "⚠️ 启用后，此渠道中 Anthropic 分组里的所有账号都会拦截 web_search 请求，请谨慎使用。",
        "webSearchEmulationGlobalDisabled": "请先在 设置 → 网关服务 → Web 搜索模拟 中启用全局开关",
        "applyPricingToAccountStats": "将定价应用到账户统计",
        "applyPricingToAccountStatsDesc": "启用后，未命中自定义规则的请求会使用标准模型价格计算账户统计",
        "accountStatsPricingRules": "账户统计自定义定价规则",
        "addRule": "添加规则",
        "noRulesConfigured": "未配置自定义规则，将使用上方渠道模型定价。",
        "ruleName": "规则名称（可选）",
        "ruleGroups": "分组",
        "ruleAccounts": "账号",
        "searchAccountPlaceholder": "搜索账号...",
        "ruleAccountsHint": "留空则匹配所有账号",
        "ruleModelPricing": "模型定价",
        "noGroupsInChannel": "上方平台标签中未选择任何分组",
        "unnamed": "未命名"
      }
    },
    "subscriptions": {
    ...
    "accounts": {
      ...
      "anthropic": {
        ...
        "webSearchEmulation": "Web 搜索模拟",
        "webSearchEmulationDesc": "为该 API Key 账号启用 Web 搜索模拟。当检测到纯 web_search 请求时，网关会调用第三方搜索 API 并在本地构造响应。默认跟随渠道配置。",
        "webSearchDefault": "默认",
        "webSearchEnabled": "启用",
      ...
      "poolModeInfo": "启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 Tabro 实例的场景。",
    ...
    "settings": {
      ...
      "linuxdo": {
        ...
        "description": "配置 LinuxDo Connect OAuth，用于 Tabro 用户登录",
      ...
      "site": {
        ...
        "interfaceLanguageHint": "仅影响当前浏览器中的后台界面语言，设置会保存在当前浏览器本地。",
        "apiBaseUrl": "API 端点地址",
      ...
      "payment": {
        ...
        "rechargeFeeRateHint": "在充值金额上额外收取的服务费百分比，0 表示不收取",
        "rechargeFeePreview": "预览：充值 100，手续费 {fee}",
      ...
      "webSearchEmulation": {
        "title": "Web 搜索模拟",
        "description": "为原生不支持 Web 搜索的 Anthropic API Key 账号注入 Web 搜索能力",
        "enabled": "启用 Web 搜索模拟",
        "enabledHint": "全局开关。关闭后，所有渠道和账号的 Web 搜索模拟都会失效。",
        "providers": "搜索服务提供商",
        "addProvider": "添加提供商",
        "providerType": "提供商类型",
        "apiKey": "API Key",
        ...
        "copied": "已复制",
        "quotaLimit": "额度上限",
        "quotaLimitHint": "留空表示不限；若填写必须大于 0",
        "quotaLimitMustBePositive": "额度上限必须大于 0",
        "subscribedAt": "订阅时间",
        "subscribedAtHint": "额度会从该日期起按月重置；留空则禁用自动重置",
        "quotaUsage": "用量",
        "resetUsage": "重置",
        "resetUsageConfirm": "确定要重置该提供商的用量计数吗？",
        "resetUsageSuccess": "用量计数已重置",
        "proxy": "代理",
        "removeProvider": "移除",
        "noProviders": "未配置搜索服务提供商",
        "test": "测试",
      ...
      "balanceNotify": {
        "title": "余额不足通知",
        "description": "当用户余额低于阈值时发送邮件通知",
        "enabled": "启用余额不足通知",
        "threshold": "默认阈值",
        "thresholdHint": "用户未设置自定义值时使用",
        "thresholdPlaceholder": "输入金额",
        "rechargeUrl": "充值页面链接",
        "rechargeUrlPlaceholder": "https://example.com/payment",
        "rechargeUrlHint": "设置后，邮件中会显示充值按钮"
      },
      "quotaNotify": {
        "title": "账号配额通知",
        "description": "当账号配额使用达到提醒阈值时通知管理员",
        "enabled": "启用账号配额通知",
        "emails": "通知邮箱",
        "emailsHint": "留空则不发送通知",
        "addEmail": "添加邮箱",
  ...
  "onboarding": {
    ...
    "admin": {
      "welcome": {
        "title": "👋 欢迎使用 Tabro",
        "description": "<div style=\"line-height: 1.8;\"><p style=\"margin-bottom: 16px;\">Tabro 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style=\"margin-bottom: 12px;\"><b>🎯 核心功能：</b></p><ul style=\"margin-left: 20px; margin-bottom: 16px;\"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style=\"color: #10b981; font-weight: 600;\">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>",
        "nextBtn": "开始配置 🚀",
        "prevBtn": "跳过"
      },
      "groupManage": {
        "title": "📦 第一步：分组管理",
        "description": "<div style=\"line-height: 1.7;\"><p style=\"margin-bottom: 12px;\"><b>什么是分组？</b></p><p style=\"margin-bottom: 12px;\">分组是 Tabro 的核心概念，它就像一个\"服务套餐\"：</p><ul style=\"margin-left: 20px; margin-bottom: 12px; font-size: 13px;\"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style=\"margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;\"><b>💡 示例：</b>您可以创建\"VIP专线\"（高倍率）和\"免费试用\"（低倍率）两个分组</p><p style=\"margin-top: 16px; color: #10b981; font-weight: 600;\">👉 点击左侧的\"分组管理\"开始</p></div>"
      },
      "createGroup": {
        "title": "➕ 创建新分组",
    ...
    "user": {
      "welcome": {
        "title": "👋 欢迎使用 Tabro",
        "description": "<div style=\"line-height: 1.8;\"><p style=\"margin-bottom: 16px;\">您好！欢迎来到 Tabro AI 服务平台。</p><p style=\"margin-bottom: 12px;\"><b>🎯 快速开始：</b></p><ul style=\"margin-left: 20px; margin-bottom: 16px;\"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style=\"color: #10b981; font-weight: 600;\">只需 1 分钟，让我们开始吧 →</p></div>",
        "nextBtn": "开始 🚀",
        "prevBtn": "跳过"
      },
      "keyManage": {
  ...
  "payment": {
    ...
    "admin": {
      ...
      "validityDaysRequired": "有效天数必须大于 0"
    },
    "paymentAmount": "支付金额",
