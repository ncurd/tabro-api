          ...
          <div class="space-y-4 p-6">
            ...
            <template v-if="form.payment_enabled">
              ...
              <div class="grid grid-cols-3 gap-3">
                <div><label class="input-label">{{ t('admin.settings.payment.productNamePrefix') }}</label><input v-model="form.payment_product_name_prefix" type="text" class="input" placeholder="Tabro" /></div>
                ...
                <div><label class="input-label">{{ t('admin.settings.payment.preview') }}</label><div class="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-600 dark:border-dark-600 dark:bg-dark-800 dark:text-gray-300">{{ (form.payment_product_name_prefix || 'Tabro') + ' 100 ' + (form.payment_product_name_suffix || 'CNY') }}</div></div>
              </div>
          ...
          <div class="px-6 py-6 space-y-4">
            ...
            <div v-if="form.balance_low_notify_enabled">
              ...
              <div class="relative">
                ...
                <input v-model.number="form.balance_low_notify_threshold" type="number" min="0" step="0.01" class="input pl-14" />
              </div>
