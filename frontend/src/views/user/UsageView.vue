        ...
        <div class="card p-4">
          <div class="flex items-center gap-3">
            <div class="rounded-lg bg-green-100 p-2 dark:bg-green-900/30">
              <Icon name="badge" size="md" class="text-green-600 dark:text-green-400" />
            </div>
            <div class="min-w-0 flex-1">
              ...
              <p class="text-xl font-bold text-green-600 dark:text-green-400">
                {{ formatCredits(usageStats?.total_actual_cost || 0, { fractionDigits: 4 }) }}
              </p>
              <p class="text-xs text-gray-500 dark:text-gray-400">
                {{ t('usage.actualCost') }} /
                <span class="line-through">{{ formatCredits(usageStats?.total_cost || 0, { fractionDigits: 4 }) }}</span>
          ...
          <template #cell-cost="{ row }">
            <div class="flex items-center gap-1.5 text-sm">
              <span class="font-medium text-green-600 dark:text-green-400">
                {{ formatCredits(row.actual_cost, { fractionDigits: 6 }) }}
              </span>
              <!-- Cost Detail Tooltip -->
              <div
                class="group relative"
        ...
        <div class="space-y-1.5">
          ...
          <div class="flex items-center justify-between gap-6 border-t border-gray-700 pt-1.5">
            ...
            <span class="font-semibold text-green-400"
              >{{ formatCredits(tooltipData?.actual_cost, { fractionDigits: 6 }) }}</span
            >
          </div>
        </div>
        <!-- Tooltip Arrow (left side) -->
