...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'azure_speech' | 'dashscope' | 'volcengine_ark'
...
const BADGE: Record<Platform, string> = {
  ...
  azure_speech: 'bg-cyan-500/10 text-cyan-600 border-cyan-500/30 dark:text-cyan-400',
  dashscope: 'bg-amber-500/10 text-amber-600 border-amber-500/30 dark:text-amber-400',
  volcengine_ark: 'bg-indigo-500/10 text-indigo-600 border-indigo-500/30 dark:text-indigo-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  azure_speech: 'bg-cyan-500/10 text-cyan-600 dark:bg-cyan-500/10 dark:text-cyan-300',
  dashscope: 'bg-amber-500/10 text-amber-600 dark:bg-amber-500/10 dark:text-amber-300',
  volcengine_ark: 'bg-indigo-500/10 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  azure_speech: 'border-cyan-500/20 dark:border-cyan-500/20',
  dashscope: 'border-amber-500/20 dark:border-amber-500/20',
  volcengine_ark: 'border-indigo-500/20 dark:border-indigo-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  azure_speech: 'bg-gradient-to-r from-cyan-400 to-cyan-500',
  dashscope: 'bg-gradient-to-r from-amber-400 to-amber-500',
  volcengine_ark: 'bg-gradient-to-r from-indigo-400 to-indigo-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  azure_speech: 'text-cyan-600 dark:text-cyan-400',
  dashscope: 'text-amber-600 dark:text-amber-400',
  volcengine_ark: 'text-indigo-600 dark:text-indigo-400',
}
...
const ICON: Record<Platform, string> = {
  ...
  azure_speech: 'text-cyan-500 dark:text-cyan-400',
  dashscope: 'text-amber-500 dark:text-amber-400',
  volcengine_ark: 'text-indigo-500 dark:text-indigo-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  azure_speech: 'bg-cyan-500 text-white hover:bg-cyan-600 active:bg-cyan-700 dark:bg-cyan-500/80 dark:hover:bg-cyan-500',
  dashscope: 'bg-amber-500 text-white hover:bg-amber-600 active:bg-amber-700 dark:bg-amber-500/80 dark:hover:bg-amber-500',
  volcengine_ark: 'bg-indigo-500 text-white hover:bg-indigo-600 active:bg-indigo-700 dark:bg-indigo-500/80 dark:hover:bg-indigo-500',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  azure_speech: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300',
  dashscope: 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300',
  volcengine_ark: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  azure_speech: 'from-cyan-500 to-cyan-600',
  dashscope: 'from-amber-500 to-amber-600',
  volcengine_ark: 'from-indigo-500 to-indigo-600',
}
...
const GRADIENT_TEXT: Record<Platform, string> = {
  ...
  azure_speech: 'text-cyan-100',
  dashscope: 'text-amber-100',
  volcengine_ark: 'text-indigo-100',
}
...
const GRADIENT_SUBTEXT: Record<Platform, string> = {
  ...
  azure_speech: 'text-cyan-200',
  dashscope: 'text-amber-200',
  volcengine_ark: 'text-indigo-200',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'azure_speech' || p === 'dashscope' || p === 'volcengine_ark'
}
...
export function platformLabel(p: string): string {
  switch (p) {
    ...
    case 'azure_speech': return 'Azure Speech'
    case 'dashscope': return 'DashScope'
    case 'volcengine_ark': return 'Volcengine Ark'
